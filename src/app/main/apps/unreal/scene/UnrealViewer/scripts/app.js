...
const styleAdditional = 'width: 100%; height: 100%;';
...
function resizePlayerStyle(event) {
  ...
  const windowSmallerThanPlayer =
    window.innerWidth < playerElement.videoWidth || window.innerHeight < playerElement.videoHeight;
  if (checkBox !== null) {
...
function toggleControlScheme() {
  ...
  console.log(
    `Updating control scheme to: ${inputOptions.controlScheme ? 'Hovering Mouse' : 'Locked Mouse'}`
  );
  if (webRtcPlayerObj && webRtcPlayerObj.video) {
